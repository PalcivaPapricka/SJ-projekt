        ...
        <div class="container py-5">
            ...
            <div class="row">
				...
				<h1>Máte záujem o prácu ?</h1>
					...
					<form class="jsklas" action="thankyou.php" method="POST">
					
						<div class="form-group">
							<label for="inputName">Meno</label>
							<input type="text" name="meno" class="form-control" id="inputName" placeholder="meno" required>
						</div>	
						...
						<div class="form-row">
							<div class="form-group">
								<label for="inputEmail4">Pozicia</label>
								<input type="text" name="pozicia" class="form-control" id="inputEmail4" placeholder="pozicia" required>
							</div>	
						
						<div class="form-group">
							<label for="exampleFormControlTextarea1">Vaše kompetencie</label>
							<textarea class="form-control" name="kompetencie" id="exampleFormControlTextarea1" rows="3" required></textarea>
						</div>
						...
						<br>
						<input  type="submit" class="btn btn-primary" name="praca_odoslat" value="Odoslat" >
						</div>
					</form>
